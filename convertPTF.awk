...
# Usage
#
# $ awk -f h:/bada/convertPTF.awk bada_3131/*.PTF > bada_3131.csv
# $ echo $?
# 0 # all ok!!!
...
BEGIN {
    print "AC_TYPE,FL,CRUISE_TAS,CRUISE_FUEL_LO,CRUISE_FUEL_NO,CRUISE_FUEL_HI,CLIMB_TAS,CLIMB_ROCD_LO,CLIMB_ROCD_NO,CLIMB_ROCD_HI,CLIMB_FUEL_NO,DESCENT_TAS,DESCENT_ROCD_NO,DESCENT_FUEL_NO"
}
...
FNR >= 17 && NF == 12 {
    printf "%s,%i,,,,,%i,%i,%i,%i,%.1f,%i,%i,%.1f\n", AC_TYPE,$1,$4,$5,$6,$7,$8,$10,$11,$12
}

FNR >= 17 && NF == 16 {
    printf "%s,%i,%i,%.1f,%.1f,%.1f,%i,%i,%i,%i,%.1f,%i,%i,%.1f\n", AC_TYPE,$1,$3,$4,$5,$6,$8,$9,$10,$11,$12,$14,$15,$16
}
